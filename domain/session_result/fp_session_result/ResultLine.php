...
class ResultLine
{
    ...
    public function getDifferenceBetween()
    {
        $lapTime = $this->getLapTime();
        $slowerLapTime = $this->getLapTime();
        return $this->calculateLapTimeDifferenceBetween($lapTime, $slowerLapTime);
    }
}
