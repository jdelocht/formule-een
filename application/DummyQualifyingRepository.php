...
class DummyQualifyingRepository implements QualifyingRepository
{
    ...
    public function getSuzukaQualifyingResult()
    {
        return [
            ...
            new QualifyingResult('Valtteri Bottas', 'Williams', 132383, 132315, false, 11),
            new QualifyingResult('Felipe Massa', 'Williams', 132562, 132380, false, 11),
            new QualifyingResult('Daniil Kvyatt', 'Torro Rosso', 132645, 132623, false, 11),
            new QualifyingResult('Carlos Sainz', 'Torro Rosso', 132789, 132685, false, 12),
            new QualifyingResult('Fernando Alonso', 'Mclaren', 132819, 132689, false, 12),
            new QualifyingResult('Joylon Palmer', 'Renault', 132796, 132807, false, 12),
            new QualifyingResult('Jenson Button', 'McLaren', 132851, false, false, 6),
            new QualifyingResult('Kevin Magnussen', 'Renault', 133023, false, false, 6),
            new QualifyingResult('Marcus Ericsson', 'Sauber', 133222, false, false, 7),
            new QualifyingResult('Felipe Nasr', 'Sauber', 133332, false, false, 7),
            new QualifyingResult('Esteban Ocon', 'Manor F1', 133353, false, false, 9),
            new QualifyingResult('Pascal Wehrlein', 'Manor F1', 133561, false, false, 9),
        ];
    }
}
